...
root.iconphoto(False, tk.PhotoImage(file='movie.png'))

canvas = tk.Canvas(root, height=HEIGHT, width=WIDTH)
canvas.pack()

background_image = tk.PhotoImage(file='pr1.png')
...
lower_frame.place(relx=0.5, rely=0.25, relwidth=0.78, relheight=0.67, anchor='n')

label = tk.Label(lower_frame, font=('Courier', 10), anchor='nw', justify='left', bd=4, wraplength=440)
